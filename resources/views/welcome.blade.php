    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
                        <p>
                        <h3>LAPOR</h3> adalah sistem laporan pengaduan Masyarakat yang dibuat untuk memudahkan
                        Masyarakat untuk memberikan laporan atau informasi kepada pihak petugas sekolah
                        </p>
                        <ul>
                            <h3>Tujuan LAPOR</h3>
                            <li><i class="ri-check-double-line"></i>Memberikan Informasi atau laporan yang jelas kepada
                                pihak sekolah supaya bisa ditindak lebih lanjut</li>
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <p>
                        <h4>LAPOR</h4>merupakan komitmen kami untuk melayani masyarakat. Dengan hadirnya sistem
                            ...
                            <div class="row">
                                <div class="col-md-6 d-md-flex align-items-md-stretch">
                                    <div class="count-box">
                                        ...
                                        <p><strong>Pengguna</strong><br>DAFTAR pengguna LAPOR</p>
                                    </div>
                                </div>
        ...
        <section id="services" class="services">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-up">
                    <h2>TATA CARA</h2>
                    <p>Nah ini dia alur pelaporan yang ada website LAPOR</p>
                </div>
